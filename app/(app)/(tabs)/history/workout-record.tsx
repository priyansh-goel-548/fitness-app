...
import { router, useLocalSearchParams, useRouter } from '@/.expo/types/router';
import { defineQuery } from 'groq';
import { client } from '@/src/lib/sanity/client';
import { GetWorkoutRecordQueryResult } from '@/types/sanity';
...
const formateTime = (dataString?: string) => {
    if(!dataString) return "Unknown Time";
    ...
    return (
        <SafeAreaView className='flex-1 bg-gray-50'>
            <View className='flex-1 justify-center items-center'>
                ...
                <Text className='text-gray-600 mt-4'>Loading workout record...</Text>
            </View>
        </SafeAreaView>
    )
};
    ...
    return (
        <SafeAreaView className='flex-1 bg-gray-50'>
            <View className='flex-1 justify-center items-center'>
                ...
                <Text className='text-xl font-semibold text-gray-900 mt-4'>Workout not found
                </Text>
                <Text className='text-gray-600 mt-2 text-center'>Workout record not found.</Text>
                <TouchableOpacity
                  onPress={() => router.back()}
        ...
        <View className='bg-white p-6 border-b border-gray-300'>
            ...
            <View className='flex-row items-center mb-3'>
                ...
                <Text className='text-gray-700 ml-3 font-medium'>
                    {formateDate(workout.date)}at {formateTime(workout.date)}
                </Text>
            </View>
                ...
                className='bg-white rounded-2xl p-6 shadow-sm border border-gray-100'>
                    ...
                    <View className='flex-row items-center justify-between mb-4'>
                        <View className='flex-1'>
                            <Text className='text-lg font-bold text-gray-900'>
                                {exerciseData.exercises?.name || "Unknown Exercise"}
                            </Text >
                    ...
                    <View className='space-y-2'>
                        ...
                        {exerciseData.sets?.map((set, setIndex) => (
                            <View key={set._key} className='bg-gray-50 rounded-lg p-3 flex-row items-center justify-between'>
