      ...
      <View className="flex-1 px-6">
        ...
        <View className="flex-1 justify-center">
            ...
            <View className="items-center mb-8">
              <View className="w-20 h-20 from-blue-600 to-purple-600 rounded-2xl items-center justify-center mb-4 shadow-lg">
        ...
        <View className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-6">
          ...
          <View className="mb-4">
            ...
            <View className='flex-row items-center bg-gray-50 rounded-xl px-4 py-4 border border-gray-200'>
              ...
              className='flex-1 ml-3 text-grey-900'
              editable = {!isLoading}
              />
            </View>
          </View>
          ...
          <View className="mb-6">
            ...
            <View className='flex-row items-center bg-gray-50 rounded-xl px-4 py-4 border borser-gray-200'>
